...
\If{$d = 0$} 
\Statex Go to Degree 3 Doubling ($d=0$) Subroutine~\ref{sub:g3explSPLIT3DBLd}.
\EndIf
\State $k' = (f - v_1(v_1 + h))/u_1 \pmod{u_1}$.
\State $s' = ds = s_2'x^2 + s_1'x + s_0' =  k't \pmod{u_1}$.
\If{$s_2' = 0$} 
\Statex Go to Degree 3 Doubling ($s_2=0$) Subroutine~\ref{sub:g3explSPLIT3DBLs2}.
\EndIf
...
\If{$r'_1$ is 0} 
\Statex Go to Degree 3 Doubling ($r'_1=0$) Subroutine~\ref{sub:g3explSPLIT3DBLr1}.
\EndIf
...
\State $d = m_1m_4 - m_2m_3$.
\If{$d = 0$}
    \Statex Go to Genus 3 Split Model Degree 2 Doubling with 2 Up Adjusts ($d=0$) Subroutine~\ref{sub:g3explSPLIT2DBL2UPd}.
\EndIf
...
\Vn_4x^4 + \Vn_3x^3 + v_{12}x^2 + v_{11}x + v_{10}$ and $u_2 = x^3 + u_{22}x^2 +
...
\State $d = t_1m_1 + t_2m_4 + t_3m_7$.
\If{$d = 0$} 
\Statex See description below.
\EndIf
\State $\vt = \vt_2x^2 + \vt_1x + \vt_0 = v_2 - v_1$.
\State $s' = ds = s_2'x^2 + s_1'x + s_0' =  \vt t \pmod{u_2}$.
\If{$s_2'$ is 0} 
\Statex Go to Degree 3 Addition ($s_2=0$) Subroutine~\ref{sub:g3explSPLIT3ADDs2}.
\EndIf
\State Compute monic quotient $q'= x + s'_2(q_0/q_1) = x + q'_0$ of $u_1/s'$ with $1/q_1 = s_2$. 
\State Compute remainder $r' = s'_2dr = r'_1x + r'_0$ of $u_1/s'$.
\If{$r'_1$ is 0}
\Statex Go to Degree 3 Addition ($r'_1=0$) Subroutine~\ref{sub:g3explSPLIT3ADDr1}.
\EndIf
\State Compute values $q_1/r_1, r_1/q_1, q_0/q_1, r_0/q_1, q_0/r_1, r_0/r_1$.
...
\begin{align*} 
    & u_{n_2} = c_6r_{q_{11}} + M'_{21} + q_{q_{01}}          \\
    & u_{n_1} = c_6(r_{\vt_2 + r_{q_{11}}t_7 + r_{q_{01}}} + r_{q_{01}}) + M'_{20} + q_{q_{01}}M'_{21}    \\
    & u_{n_0} = c_6(r_{\vt_2r_{r_{01}} + r_{q_{01}}}(t_7 + r_{r_{01}})) + q_{q_{01}}M'_{20}.
\end{align*}
...
\If{$d = 0$}
    ...
    \Statex Go to Step~12 and let $d = d_w$.
\EndIf
...
\If{$d = 0$}
    ...
    \State $z = z_3x^3 + z_2x^2 + z_1x + z_0 = (f - v_1(v_1 + h))/(c_4u_1) \s\s\s$ (exact division).  
    \State $s_0' = d_ws_0 = z \pmod{u_2}$.
    \Statex Go to Step~18 and let $d = d_w$.
\EndIf
\State $s_0' = ds_0 = (v_2 - v_1) \pmod{u_2}$ with weight $d$.
\State $z = z_3x^3 + z_2x^2 + z_1x + z_0 = (f - v_1(v_1 + h))/(c_4u_1) \s\s\s$ (exact division).  
\If{$s_0' = 0$} 
...
\If{$d = 0$}
    ...
    \State $z = z_3x^3 + z_2x^2 + z_1x + z_0 = (f - v_1(v_1 + h))/(c_4u_1) \s\s\s$ (exact division).  
    \State $s_0(d_w) = z \pmod{u_2}$.
    \Statex Go to Step~10 with $d = d_w$.
\EndIf
\State $z = z_3x^3 + z_2x^2 + z_1x + z_0 = (f - v_1(v_1 + h))/(c_4u_1) \s\s\s$ (exact division).  
\State $s_0 = (v_2 - v_1)/d \pmod{u_2}$.
\If{$s_0'$ is 0} 
...
&42&5&66&27 &40&6&57&7  &38&7&44&10\TS\\
\hline
Degree 2
...
&33&2&48&21 &30&4&37&7 &31&3&37&11\TS\\
\hline
...
&37&2&54&21 &33&5&42&6 &34&4&39&10\TS\\
\hline
...
&40&2&60&22 &36&5&44&3 &37&3&46&9\TS\\
\hline
Degree 1 
...
\hline
Degree 1 with two Up Adjusts 
&41&4&57&23 &38&6&46&8 &38&6&45&10\TS\\
\hline
Degree 1 and 2
...
&47&5&67&22 &44&7&54&6 &44&7&50&9\TS\\
\hline
Degree 1 and 3
...
&53&4&74&22 &49&7&62&3 &51&5&56&7\TS\\
\hline
Degree 2
&37&1&56&7  &36&2&57&0  &33&4&52&0\TS\\
\hline
Degree 2 with Up Adjust 
&30&1&47&8  &29&2&47&0  &29&2&41&0\TS\\
\hline
Degree 2 with two Up Adjusts 
&61&3&78&25 &56&6&72&5  &57&5&66&8\TS\\
\hline
Degree 2 and 3
&41&1&59&3  &41&1&57&0  &41&1&55&0\TS\\
\hline
