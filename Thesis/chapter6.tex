...
Algorithm~\ref{alg:g3explSPLIT3DBL}. The explicit formula for Step~15 is
\begin{align*}
    t_0 &= v_{12} - \Vn_2,\\
    k_3 &= c_4t_0,\\
...
of additions of a divisor class with itself. Each chain length was scaled with
the field size, from $500{,}000$ steps at $2$ bits down to $45{,}000$ at $1024$
bits, and every reported timing is the mean of $5$ trials. Timings range over
