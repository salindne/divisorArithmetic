...
by Step~19 of Balanced Doubling Algorithm~\ref{alg:g2balnudupl}, and $n_n = -1 + 3 -
\deg(u_n) = 2 - \deg(u_n)$ for Degree 1 Doubling with Up Adjust by Step~20 of
...
additions of a divisor class with itself. Each chain length was scaled with the
field size, from $500{,}000$ steps at $2$ bits down to $45{,}000$ at $1024$
bits, and every reported timing is the mean of $5$ trials. Timings taken over a
...
\begin{itemize}
    ...
    divisor classes is between $22\%$ and $38\%$ slower than ramified arithmetic
    for addition, and between $28\%$ and $53\%$ slower for doubling, for genus 2
    curves over prime fields from $4$ to $1024$ bits.
\end{itemize}
