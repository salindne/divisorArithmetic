...
| gate | result |
|---|---|
| Magma suite, `./test_all.sh` | **28 testers, 0 failures, 0 skips**, ~45 min |
...
That runs 28 testers in about 45 minutes and exits 0. Every family now has a whitebox tester, so there is nothing left to skip; see
[Status](#status).
